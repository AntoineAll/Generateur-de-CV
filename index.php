...
<head>
    ...
    <title>CV Gen | Créez votre avenir</title>
    ...
    <style>
        ...
        /* Dégradé stylé pour le header */
        .hero-section {
            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
            color: white;
            padding: 100px 0;
            clip-path: ellipse(150% 100% at 50% 0%); /* Petit effet de courbe en bas */
        }
        ...
        .btn-modern:hover {
            transform: translateY(-3px); /* Le bouton monte un peu au survol */
        }
        ...
        <div class="row g-4 text-center">
            <div class="col-md-4">
                <div class="card feature-card p-4 h-100">
                    ...
                    <h3>Rapide</h3>
                    <p class="text-muted">Remplissez le formulaire et votre CV est prêt instantanément.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card feature-card p-4 h-100">
                    <div class="fs-1 mb-3">🎨</div>
                    <h3>Moderne</h3>
                    <p class="text-muted">Des designs épurés qui plaisent aux recruteurs d'aujourd'hui.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card feature-card p-4 h-100">
                    <div class="fs-1 mb-3">📄</div>
                    <h3>PDF Prêt</h3>
                    <p class="text-muted">Un export PDF propre, sans bugs de mise en page.</p>
                </div>
            </div>
        </div>
    </main>
