...
<head>
    ...
    <style>
        ...
        .desc-text { font-size: 0.75rem; color: #636e72; white-space: pre-line; }
    </style>
</head>
<body>
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <details>
                                    ...
                                    <div class="info-preview">
                                        ...
                                        <div class="mt-2 text-muted desc-text"><?php echo htmlspecialchars($entry['resume']); ?></div>
                                        ...
                                        <?php if(!empty($entry['experience_titre'])): ?>
                                            ...
                                            <?php foreach($entry['experience_titre'] as $i => $titre): ?>
                                                <div class="item-detail">
                                                    ...
                                                    <small class="text-muted"><?php echo htmlspecialchars($entry['experience_lieu'][$i]); ?></small>
                                                </div>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </div>
